...
function PdfViewer(param) {
    let { pdfData, onFieldsExtracted, selectedFields, onFieldClick, groupedFields = new Set(), linkingMode = false } = param;
    _s();
                ...
                children: [
                    ...
                    getFieldsForCurrentPage().map((field, index)=>{
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            title: "".concat(field.name, " (").concat(field.type, ")").concat(isGrouped ? ' - GROUPED' : ''),
                            onMouseEnter: (e)=>{
...
function SchemaItemEditor(param) {
    let { item, onSave, onCancel, onStartLinking, linkingMode } = param;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            localItem.display_attributes.value.type === "reserved" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                style: {
                    marginBottom: "12px",
                    paddingLeft: "20px"
                },
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                option.linkedFields && option.linkedFields.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    style: {
                                                        marginTop: "4px"
                                                    },
                                                    children: option.linkedFields.map((linkedId, linkIndex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            style: {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    onClick: ()=>{
                                                                        var _newItem_display_attributes_checkbox_options_options_index, _newItem_display_attributes_checkbox_options;
                                                                        const newItem = {
                                                                            ...localItem
                                                                        };
                                                                        if ((_newItem_display_attributes_checkbox_options = newItem.display_attributes.checkbox_options) === null || _newItem_display_attributes_checkbox_options === void 0 ? void 0 : (_newItem_display_attributes_checkbox_options_options_index = _newItem_display_attributes_checkbox_options.options[index]) === null || _newItem_display_attributes_checkbox_options_options_index === void 0 ? void 0 : _newItem_display_attributes_checkbox_options_options_index.linkedFields) {
                                                ...
                                                onStartLinking && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    onClick: ()=>{
                                                        onSave(localItem); // Save current state first
                                                        onStartLinking("".concat(localItem.unique_id, ".").concat(index));
                                                    },
                                                    disabled: (linkingMode === null || linkingMode === void 0 ? void 0 : linkingMode.checkboxOptionPath) === "".concat(localItem.unique_id, ".").concat(index),
                                                    style: {
                                                        marginTop: "8px",
                                                        padding: "4px 8px",
                                                        background: (linkingMode === null || linkingMode === void 0 ? void 0 : linkingMode.checkboxOptionPath) === "".concat(localItem.unique_id, ".").concat(index) ? "#fbbf24" : "#3b82f6",
                                                        color: "white",
                                                        border: "none",
                                                        borderRadius: "4px",
                                                        cursor: (linkingMode === null || linkingMode === void 0 ? void 0 : linkingMode.checkboxOptionPath) === "".concat(localItem.unique_id, ".").concat(index) ? "not-allowed" : "pointer",
                                                        fontSize: "12px"
                                                    },
                                                    children: (linkingMode === null || linkingMode === void 0 ? void 0 : linkingMode.checkboxOptionPath) === "".concat(localItem.unique_id, ".").concat(index) ? "🔗 Linking Active - Click a field in PDF" : "Add Linked Field"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/src/components/SchemaItemEditor.tsx",
                                                    lineNumber: 414,
                                                    columnNumber: 21
...
function SchemaEditor(param) {
    let { schema, onSchemaChange, fieldGroup, formType, onStartLinking, linkingMode } = param;
    _s();
...
function ProjectPage() {
    ...
    const [fileName, setFileName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null); // eslint-disable-line @typescript-eslint/no-unused-vars
    ...
    const [linkingMode, setLinkingMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const onFiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProjectPage.useCallback[onFiles]": async (files)=>{
            ...
            try {
                ...
                var _this;
                console.error(e);
                setError(((_this = e) === null || _this === void 0 ? void 0 : _this.message) || "Failed to read/save file.");
            }
        }
    ...
    const handleFieldClick = (field)=>{
        ...
        if (linkingMode) {
            ...
            const linkedSchemaItem = schema.find((item)=>{
                var _item_pdf_attributes;
                return (_item_pdf_attributes = item.pdf_attributes) === null || _item_pdf_attributes === void 0 ? void 0 : _item_pdf_attributes.some((attr)=>{
                    var _attr_linked_form_fields_text;
                    return attr.formfield === field.name || Array.isArray(attr.formfield) && attr.formfield.includes(field.name) || ((_attr_linked_form_fields_text = attr.linked_form_fields_text) === null || _attr_linked_form_fields_text === void 0 ? void 0 : _attr_linked_form_fields_text.includes(field.name));
                });
            });
            if (linkedSchemaItem) {
                ...
                setLinkingMode(null);
                alert("Linked to ".concat(linkedSchemaItem.display_attributes.display_name || linkedSchemaItem.unique_id));
            } else {
    ...
    const getGroupedFields = ()=>{
        ...
        schema.forEach((item)=>{
            var _item_pdf_attributes;
            (_item_pdf_attributes = item.pdf_attributes) === null || _item_pdf_attributes === void 0 ? void 0 : _item_pdf_attributes.forEach((attr)=>{
                var _attr_linked_form_fields_text, _attr_linked_form_fields_checkbox, _attr_linked_form_fields_radio;
                ...
                (_attr_linked_form_fields_text = attr.linked_form_fields_text) === null || _attr_linked_form_fields_text === void 0 ? void 0 : _attr_linked_form_fields_text.forEach((f)=>grouped.add(f));
                (_attr_linked_form_fields_checkbox = attr.linked_form_fields_checkbox) === null || _attr_linked_form_fields_checkbox === void 0 ? void 0 : _attr_linked_form_fields_checkbox.forEach((f)=>grouped.add(f.pdfAttribute));
                (_attr_linked_form_fields_radio = attr.linked_form_fields_radio) === null || _attr_linked_form_fields_radio === void 0 ? void 0 : _attr_linked_form_fields_radio.forEach((f)=>grouped.add(f.radioField));
            });
        });
        return grouped;
    };
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            linkingMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            linkingMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                style: {
                                    padding: "10px",
                                    background: "#fef3c7",
...
_s(ProjectPage, "w+DX8tVvr/ure4Bq9keSiHA+xJQ=", false, function() {
    return [
...
//# sourceMappingURL=app_src_87630c12._.js.map